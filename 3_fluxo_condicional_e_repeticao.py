# -*- coding: utf-8 -*-
"""3_fluxo_condicional_e_repeticao.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Ey2pgY7jmzsEHCPqMyFtfkup-3Ew0y6T
...
**Na lista abaixa estão presentes os dados de usuários que
...
"""**1.0 Criando a lista 'paises' com o país dos usuários com mais de 30 anos:**"""
...
"""**1.1 Criando a lista 'leads' com a renda dos usuários que clicaram na
propaganda:**
"""
...
for dado_de_usuario in propaganda_online:
  try:
    ...
    print('Informação "clicou_no_ad" não foi encontrada na tabela.')

print(leads)

"""**1.2 Criando a lista 'cidades' com a cidade dos usuários que passaram mais de
70 segundos no site.**
"""
...
for dado_de_usuario in propaganda_online:
  try:
    ...
    print('Operação com tipo de objeto incorreto.') 
